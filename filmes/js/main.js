...
function buscarFilmes(filmePesquisar){
  ...
  axios.get('http://www.omdbapi.com/?s=' + filmePesquisar + '&apikey=ffe257d5')
        ...
        mostrarFilmes += `
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <p><a href="#" class="btn btn-primary role="button" onclick="filmeDetalhes('${filmes[i].imdbID}')"> Detalhes</a></p>
                </div>
            </div>
        `;
    }
...
function mostraFilme(){
    ...
    axios.get('http://www.omdbapi.com/?i=' + filmeID + '&apikey=ffe257d5')
  .then(function (response) {
    ...
    var mostraFilme = `
            ...
            <div class="col-md-6">
                <div class="well clearfix">
                    ...
                    ${filme.Plot}
                    <hr>
                    <a href="http://imdb.com/title/${filme.imdbID}" target="_blank" class="btn btn-success" pull-left">Assistir</a>
                    <a href ="index.html" target="_blank" class="btn btn-success" pull-right">Voltar </a>
                    <br/><br/>
                    </hr>
                </div>
            </div>     
